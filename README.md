...
認可後は自動的にGAS Webアプリへリダイレクトされ、トークンが自動取得されます。
...
| バージョン | 日付 | 内容 |
| ----- | ---------- | -------------- |
| 1.1.0 | 2026-01-04 | doGet関数で認可コードを受信し、トークンを自動取得する機能を追加。AuthシートA3セル（Authorization Code）は原則不要に |
